...
void GeneralPlayer::attackTo(AbstractMonster*monster)
{
	...
	else
	{
		...
		{
			int Damage = damage_calculate(attack, monster->defense);
...
{
	if (Sword_Weapon_equip ==NULL && race == "Knight")
	{
...
{
	if (Axe_Weapon_equip == NULL && race == "Orc")
	{
...
{
	if (Magic_Weapon_equip == NULL&&race=="Magic")
	{
...
{
	if (Shield_Armor_equip == NULL && race == "Knight")
	{
